...
# Source Files
SOURCEFILES=CONFIGURATION.c main.c SYSTEM.c EXCEPTIONS.c INTERRUPTS.c USER.c MISC.c DMA.c UART.c ADC.c TIMERS.c PWM.c FLASH.c POWER.c SPI.c RDI.c
